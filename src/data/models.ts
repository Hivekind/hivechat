...
export const models: Model[] = [
  {
    ...
    name: "gpt-4o",
    type: "OpenAI",
    description: "A high-intelligence flagship model for complex, multi-step tasks.",
    strengths: "",
  },
  {
  ...
  },
  {
    ...
    description: "A fast and versatile multimodal model for scaling across diverse tasks.",
    type: "Gemini",
    strengths:
  ...
  },
  {
    ...
    name: "gemini-1.5-pro",
    description: "A mid-size multimodal model that is optimized for a wide-range of reasoning tasks.",
    type: "Gemini",
    strengths: "",
  },
  {
    ...
    name: "gemini-1.0-pro",
    description: "A Natural Language Processing model that handles tasks like multi-turn text and code chat, and code generation.",
    type: "Gemini",
    strengths:"",
  },
];
